...
const ERROR_MESSAGES: Record<string, string> = {
  "not-found": "We couldn't find that restaurant.",
  "not-authorized": "Your account isn't an admin for this restaurant.",
};

export default function AdminLoginPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-sm rounded-xl border border-neutral-200 bg-white p-8 shadow-sm">
        <h1 className="text-xl font-semibold text-neutral-900">Restaurant admin login</h1>
        <p className="mt-1 text-sm text-neutral-500">Sign in to manage orders for {slug}.</p>
